...
> torch: The core PyTorch library for working with deep learning models.
> transformers: For utilizing the RoBERTa transformer model and tokenizers.
> sklearn: Provides essential tools for data splitting, evaluation metrics, and preprocessing.
> xgboost: Implements the XGBoost algorithm for classification.
